export const DISCLAIMER_DEFAULT =
  "Los precios, promociones y disponibilidad están sujetos a cambio sin previo aviso. El precio \"desde\" mostrado en esta página aplica únicamente a lotes seleccionados, no a la totalidad del fraccionamiento. Las imágenes son ilustrativas y pueden no representar la ubicación exacta de cada lote.";

export const TERMINOS_DEFAULT = `Términos y Condiciones
...
export const PRIVACIDAD_DEFAULT = `Aviso de Privacidad
