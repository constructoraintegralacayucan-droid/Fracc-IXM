...
import { loginCliente, type LoginClienteState } from "@/app/cliente/actions";

const initialState: LoginClienteState = { ok: false, message: "" };

export function ClienteLoginForm() {
  const [state, formAction] = useActionState(loginCliente, initialState);
