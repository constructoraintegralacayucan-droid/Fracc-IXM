...
import { PortadaUploader } from "@/components/portada-uploader";
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="mt-8 space-y-3">
        {desarrollos.map((d) => (
          <div
            key={d.id}
            className="flex flex-col gap-4 rounded-2xl border border-forest-900/10 bg-sand-50 p-5"
          >
            ...
            <div className="border-t border-forest-900/10 pt-4">
              <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-forest-700/60">
                Foto de portada (se muestra en la tarjeta de este desarrollo)
              </p>
              <PortadaUploader
                desarrolloId={d.id}
